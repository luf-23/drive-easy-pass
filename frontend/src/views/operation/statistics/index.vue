...
import { getStatisticsOverview, getEnrollmentTrend, getPassRate } from '@/api/statistics';
        ...
        <el-row :gutter="16" class="mb-4">
            <el-col :xs="24" :sm="12" :md="6">
                <el-card shadow="hover">
                    ...
                    <div class="text-3xl font-bold text-blue-500">{{ overview.totalUsers || 0 }}</div>
                </el-card>
            </el-col>
            <el-col :xs="24" :sm="12" :md="6">
                <el-card shadow="hover">
                    ...
                    <div class="text-3xl font-bold text-green-500">{{ overview.activeUsers || 0 }}</div>
                </el-card>
            </el-col>
            <el-col :xs="24" :sm="12" :md="6">
                <el-card shadow="hover">
                    ...
                    <div class="text-3xl font-bold text-purple-500">{{ overview.totalEnrollments || 0 }}</div>
                </el-card>
            </el-col>
            <el-col :xs="24" :sm="12" :md="6">
                <el-card shadow="hover">
                    ...
                    <div class="text-3xl font-bold text-orange-500">{{ overview.monthlyEnrollments || 0 }}</div>
                </el-card>
            </el-col>
        </el-row>
                ...
                <el-card shadow="hover">
                    ...
                    <div v-if="passRateData.subject1 !== undefined" class="p-4 space-y-4">
                        <div class="flex items-center">
                            ...
                            <el-progress class="flex-1" :percentage="passRateData.subject1 || 0"
                                :color="customColors" />
                        </div>
                        <div class="flex items-center">
                            <span class="inline-block w-20 text-gray-600">科目二:</span>
                            <el-progress class="flex-1" :percentage="passRateData.subject2 || 0"
                                :color="customColors" />
                        </div>
                        <div class="flex items-center">
                            <span class="inline-block w-20 text-gray-600">科目三:</span>
                            <el-progress class="flex-1" :percentage="passRateData.subject3 || 0"
                                :color="customColors" />
                        </div>
                        <div class="flex items-center">
                            <span class="inline-block w-20 text-gray-600">科目四:</span>
                            <el-progress class="flex-1" :percentage="passRateData.subject4 || 0"
                                :color="customColors" />
                        </div>
                    </div>
